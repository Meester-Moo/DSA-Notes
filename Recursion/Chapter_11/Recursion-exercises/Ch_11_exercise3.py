...
# number in the sequence). Write a function that accepts a number for N and returns the correct number 
# from the series. That is, if the function was passed the number 7, the function would return 28.